...
grep -q '^\[methprobe fetch\] hg38/probe: 1 of 1 files come from an earlier release of zhou-lab/probe than this build pins (one.cm); replace them with: methprobe fetch -y -f hg38/probe' r.txt ||
